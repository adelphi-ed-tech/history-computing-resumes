...
const summary = `
Hi. I'm Muhammad ibn Musa al-Khwarizmi. 
I literally wrote the book on algebra and algorithms,
which is why both words are derived from my name.
I'm looking for a position where I can revolutionize
the world of mathematics and lay the groundwork
for computing for the next millennia.
`
